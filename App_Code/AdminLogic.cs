            ...
            if (CommonLogic.FormBool("IsSubmit"))
            {
                if (ErrorMsg.Length == 0)
                {
                    ...
                    if (!Editing)
                    {
                        ...
                        {
                            sql.Append(DB.SQuote(SE.MungeName(CommonLogic.FormCanBeDangerousContent("Name_" + Localization.GetDefaultLocale().Replace("-", "_")))) + ",");
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        sql.Append("SEName=" + DB.SQuote(SE.MungeName(CommonLogic.FormCanBeDangerousContent("Name_" + Localization.GetDefaultLocale().Replace("-", "_")))) + ",");
