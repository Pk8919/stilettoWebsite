        ...
        private MenuItem GetChildMenuItems(MenuItem parent)
        {
            switch (parent.Value.ToLowerInvariant())
            {
                ...
                case "orders":
                    ...
                    MenuItem childReports = GetMenuItem("admin.menu.Reports", "reports");
                    childReports.ChildItems.Add(GetMenuItem("admin.menu.ReportCustomer", "reportsCustomer", "rpt_customers.aspx"));
                    childReports.ChildItems.Add(GetMenuItem("admin.menu.ReportOrder", "reportsOrder", "rpt_orders.aspx"));
                    childReports.ChildItems.Add(GetMenuItem("admin.menu.ReportByCategory", "reportsCategory", "orderreports.aspx"));
                    childReports.ChildItems.Add(GetMenuItem("admin.menu.ReportStats", "reportsStats", "rpt_stats.aspx"));
                    childReports.ChildItems.Add(GetMenuItem("admin.menu.ReportEmail", "reportsEmail", "rpt_emails.aspx"));
                    childReports.ChildItems.Add(GetMenuItem("admin.menu.ReportCustom", "reportsCustom", "rpt_custom.aspx"));
                    parent.ChildItems.Add(childReports);
                ...
                case "configuration":
                    ...
                    childAdvanced.ChildItems.Add(GetMenuItem("admin.menu.AddinManager", "advancedViewAddinManager", "addinmanager.aspx"));
                    ...
                    childShipping.ChildItems.Add(GetMenuItem("admin.menu.ShippingImportExport", "shippingImportExport", "ordershipment1.aspx"));
