                    ...
                    <Columns>
                            ...
                            <HeaderTemplate>
                                <div class="map_header">
                                    Map: <a href="javascript:void(0);" onclick="javascript:mapAll(true);">All,</a>&nbsp;
                                        ...
                                        <asp:LinkButton ID="lnkSave" runat="server" CommandName="SaveMapping"><img runat="server" src="~/App_Themes/Admin_Default/images/save_small.gif" alt="save" style="border-style:none; margin: 0px 0px -3px 0;" /> Save</asp:LinkButton>
                                </div>
                            </HeaderTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" SortExpression="Name">
                         ...
                         <telerik:GridTemplateColumn HeaderText="Clone" ItemStyle-Width="50px" HeaderStyle-Width="50px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" CommandName="CloneProducts" ToolTip="Clone Product" OnClientClick="return confirm('Are you sure you want to clone this product?');"><img runat="server" src="~/App_Themes/Admin_Default/images/clone.png" alt="Clone Product" style="border-style:none; margin: 0px 0px -3px 0;" /></asp:LinkButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Soft Delete" ItemStyle-Width="50px" HeaderStyle-Width="50px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteProducts" ToolTip="Delete Product" OnClientClick="return confirm('Are you sure you want to mark this product as deleted?');" Visible="false"><img runat="server" src="~/App_Themes/Admin_Default/images/delete.png" alt="Delete Product" style="border-style:none; margin: 0px 0px -3px 0;" /> </asp:LinkButton>
                                <asp:LinkButton ID="lnkUndelete" runat="server" CommandName="UndeleteProducts" ToolTip="Undelete Product" OnClientClick="return confirm('Are you sure you want to undelete this product?');" Visible="false"><img runat="server" src="~/App_Themes/Admin_Default/images/undelete.png" alt="Undelete Product" style="border-style:none; margin: 0px 0px -3px 0;" /> </asp:LinkButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Nuke" ItemStyle-Width="50px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkNuke" runat="server" CommandName="NukeProducts" ToolTip="Nuke Product" OnClientClick="return confirm('Are you sure you want to nuke this product? This cannot be undone.');"><img runat="server" src="~/App_Themes/Admin_Default/images/delete.png" alt="Nuke Product" style="border-style:none; margin: 0px 0px -3px 0;" /></asp:LinkButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
                </MasterTableView>
