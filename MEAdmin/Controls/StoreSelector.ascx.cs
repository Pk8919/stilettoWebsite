...
public partial class StoreSelector : System.Web.UI.UserControl
{
    ...
    private void GetData()
    {
        ...
        //if ((SelectMode == StoreSelectedMode.SingleDropDown || SelectMode == StoreSelectedMode.SingleRadioList) && m_showdefaultforallstores)
        //{
        //    Store d = new Store();
        //    d.Name = "Default for all stores";
        //    d.StoreID = 0;
        //    xList.Add(d);
        //}
        ...
        switch (SelectMode)
        {
            ...
            case StoreSelectedMode.SingleRadioList:
                ...
                {
                    cmbSingleList.Items.Insert(0, new ListItem("Default for all stores", "0"));
                }
                break;
