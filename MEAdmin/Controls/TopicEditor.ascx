        ...
        <tr>
            ...
            <td align="left" valign="top">
                ...
                <tcontrol:RadEditor runat="server" RadControlsDir="rad" id="radDescription">
                                    <ImageManager MaxUploadFileSize="4200000" UploadPaths="~/Images" ViewPaths="~/Images" DeletePaths="~/Images" />
                                    <DocumentManager MaxUploadFileSize="4200000" UploadPaths="~/Images" ViewPaths="~/Images" DeletePaths="~/Images" />
                                    <FlashManager MaxUploadFileSize="4200000" UploadPaths="~/Images" ViewPaths="~/Images" DeletePaths="~/Images" />
                                    <MediaManager MaxUploadFileSize="4200000" UploadPaths="~/Images" ViewPaths="~/Images" DeletePaths="~/Images" />
                                    <SilverlightManager MaxUploadFileSize="4200000" UploadPaths="~/Images" ViewPaths="~/Images" DeletePaths="~/Images" />
                                    <TemplateManager MaxUploadFileSize="4200000" UploadPaths="~/Images" ViewPaths="~/Images" DeletePaths="~/Images" />
                </tcontrol:RadEditor>
            </td>
        </tr>
        <tr>
