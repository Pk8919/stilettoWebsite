                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="left" style="padding-left: 4px;">
                                ...
                                <asp:RegularExpressionValidator ID="rgxvEmail" runat="server" ErrorMessage="<%$ Tokens:StringResource, admin.customer.EmailValidationFailed %>"
                                    ControlToValidate="txtEmail" ValidationGroup="vldMain" ValidationExpression="^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" />
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
