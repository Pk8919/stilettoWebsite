...
<asp:Content runat="server" ContentPlaceHolderID="bodyContentPlaceholder">
    ...
    <asp:GridView ID="grdData" runat="server" onrowcommand="grdData_RowCommand" 
        ...
        <Columns>
            <asp:ButtonField ButtonType="Button" CommandName="Unsubscribe" 
                HeaderText="<%$Tokens:StringResource, admin.common.Unsubscribe %>" Text="<%$Tokens:StringResource, admin.common.Unsubscribe %>" />
        </Columns>
        <EmptyDataTemplate>
            &nbsp;
        </EmptyDataTemplate>
