...
";
        ...
        protected void grdData_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            {
                ExecuteUnsubscribe(NewsletterList.Rows[item]["EmailAddress"].ToString());
                NewsletterList.Rows[item][Labels.SubscriptionConfirmed] = false;
                NewsletterList.Rows[item][Labels.UnsubscribedOn] = DateTime.Now;
                gridRefresh();
            }
        }
