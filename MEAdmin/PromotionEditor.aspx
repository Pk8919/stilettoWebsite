...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="Scripts/promotions.js" type="text/javascript"></script>
</asp:Content>
    ...
    <div class="bodywrapper ui-widget">
        <asp:Panel ID="pnlView" runat="server" DefaultButton="btnSearch">
            ...
            <asp:GridView ID="gridPromotions" runat="server" DataSourceID="PromotionDataSource"
                ...
                PageSize="10" OnSelectedIndexChanged="gridPromotions_SelectedIndexChanged" CellPadding="5"
                                    ...
                                    <tr id="trShippingOnlyDiscount" runat="server">
                                        ...
                                        <td>
                                            ...
                                            <h3 class="checkHeader">
                                                ...
                                                <asp:RadioButton GroupName="rblDiscountList" ID="chkShippingOnlyDiscount" runat="server" CssClass="checkToggler" Checked="true" />
                                            ...
                                            <div class="checkTarget">
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <telerik:RadDatePicker ID="txtRuleStartDate" runat="server" Style="z-index: 150000;" MaxDate="9999-12-31">
                                                                <Calendar runat="server" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" ViewSelectorText="x" />
                                                                <DatePopupButton HoverImageUrl="" ImageUrl="" />
                                                            </telerik:RadDatePicker>
                                                            <asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="txtRuleStartDate" ErrorMessage="<%$Tokens:StringResource, admin.PromotionEditor.ValidationIncorrectDateFormat%>" Type="Date" Operator="DataTypeCheck" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="checkTarget">
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <telerik:RadDatePicker ID="txtRuleExpirationDate" runat="server" Style="z-index: 150000;" MaxDate="9999-12-31">
                                                                <Calendar runat="server" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" ViewSelectorText="x" />
                                                                <DatePopupButton HoverImageUrl="" ImageUrl="" />
                                                            </telerik:RadDatePicker>
                                                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtRuleExpirationDate" ErrorMessage="<%$Tokens:StringResource, admin.PromotionEditor.ValidationIncorrectDateFormat%>" Type="Date" Operator="DataTypeCheck" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
