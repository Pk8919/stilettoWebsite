...
public partial class _PromotionEditor : AspDotNetStorefrontAdmin.AdminPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CallToActionTextbox.Attributes.Add("value", "admin.PromotionEditor.callToActionDefaultText".StringResource());
    ...
    {
        Int32 id = (Int32)gridPromotions.SelectedPersistedDataKey.Value;
        EditForm(id);
    }
    ...
    private void ToggleView(Boolean editing, Boolean isNewRecord)
    {
        ...
        pnlShippingDiscount.Enabled =
            pnlShippingOnlyDiscount.Enabled =
            CSVHelper2.Visible = !AppLogic.AppConfigBool("AllowMultipleShippingAddressPerOrder") && !AppLogic.AppConfigBool("ShowGiftRegistryButtons");
    }
    ...
    private void ClearForm()
    {
        ...
        optRuleExpirationNumberOfUses.Checked = 
            chkRuleExpirationNumberOfUsesPerCustomer.Checked = false;
        ...
        chkShippingOnlyDiscount.Checked = true;
