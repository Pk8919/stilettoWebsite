                                                ...
                                                <asp:TemplateField HeaderText="<%$Tokens:StringResource, admin.common.Edit %>">
                                                    <ItemTemplate>
                                                        <a href='editAffiliates.aspx?iden=<%# DataBinder.Eval(Container.DataItem, "AffiliateID")%>'>
                                                            <asp:ImageButton ID="imgEdit" CommandName="EditItem" CommandArgument='<%# Eval("AffiliateID") %>' runat="Server" AlternateText="<%$Tokens:StringResource, admin.common.Delete %>" ImageUrl="~/App_Themes/Admin_Default/images/edit.gif" />
                                                        </a>                                                        
                                                    </ItemTemplate>
                                                </asp:TemplateField>
