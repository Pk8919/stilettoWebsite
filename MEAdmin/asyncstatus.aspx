...
<body>
    ...
    <div align="center">
        ...
        <asp:Literal runat="server" ID="ltlEstRemaining" Text="<%$ Tokens:StringResource, admin.asyncstatus.EstimatedTimeRemaining %>" /> <b><asp:Literal runat="server" ID="ltlTimeRemaining" /></b><br />
    </div>
    </form>
</body>
</html>
