    ...
    public partial class cst_history : AdminPageBase
    {
        ...
        private void Render()
        {
            ...
            if (control)
            {
                ...
                writer.Append("<table width=\"100%\" cellpadding=\"2\" cellspacing=\"0\" border=\"0\" style=\"border-style: solid; border-width: 0px; border-color: #" + AppLogic.AppConfig("HeaderBGColor") + "\">\n");
                writer.Append("<tr><td align=\"left\" valign=\"top\">\n");
                writer.Append("<a href=\"" + AppLogic.AdminLinkUrl("news.aspx") + "\"><img src=\"" + AppLogic.LocateImageURL("~/App_Themes/Admin_Default/images/orderhistory.gif") + "\" border=\"0\"></a><br/>");
                ...
                writer.Append("<td valign=\"top\"><b>" + AppLogic.GetString("adnin.common.OrderTotal", SkinID, LocaleSetting) + "</b></td>\n");
