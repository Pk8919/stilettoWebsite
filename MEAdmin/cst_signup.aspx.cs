    ...
    public partial class cst_signup : AdminPageBase
	{
        ...
        private void Render()
        {
            ...
            if (!AppLogic.ProductIsMLExpress())
            {
                ...
                writer.Append("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                writer.Append("        <input type=\"text\" name=\"SubscriptionExpiresOn\" id=\"SubscriptionExpiresOn\" size=\"12\" value=\"\">&nbsp;<img src=\"" + AppLogic.LocateImageURL("~/App_Themes/Admin_Default/images/calendar.gif") + "\" style=\"cursor:hand;cursor:pointer;\" align=\"absmiddle\" id=\"f_trigger_s\">");
