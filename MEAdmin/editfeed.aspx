...
<div style="margin-bottom: 5px; margin-top: 5px;">
        ...
        <p>
           <b> <asp:Label runat="server" Text= "<%$Tokens:StringResource, admin.editfeed.header %>" /> <br /> <asp:Label runat="server" Text="<%$Tokens:StringResource, admin.editfeed.fieldsmarked %>" /> </b>
        </p>        
        <div id="container">
                ...
                <td>
                    <div class="wrapper">                       
                        <table border="0" cellpadding="0" cellspacing="0" class="innerTable" width="100%">
                            <tr>
                                <td class="titleTable">
                                    <font class="subTitle"> <asp:Label runat="server" Text="<%$Tokens:StringResource, admin.editfeed.ProductFeeds %>" /> </font>
                                </td>
                            </tr>
                            <tr>
                                <td class="contentTable" valign="top" width="100%">
                                    <div class="wrapperLeft">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td><font class="subTitleSmall"><asp:Label runat="server" Text= "<%$Tokens:StringResource, admin.editfeed.store %>" /></font></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><font class="subTitleSmall"><asp:Label runat= "server" Text="<%$Tokens:StringResource, admin.editfeed.Feedname %>" /></font></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><font class="subTitleSmall"> <asp:Label runat="server" Text ="<%$Tokens:StringResource, admin.editfeed.XmlPackage %>" /></font></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><font class="subTitleSmall"><asp:Label runat="server" Text ="<%$Tokens:StringResource, admin.editfeed.AutoFTP %>" /></font></td>
                                            ...
                                            <tr>
                                                <td><font class="subTitleSmall"> <asp:Label ID="Label2" runat="server" Text ="<%$Tokens:StringResource, admin.editfeed.FTPUsername %>" /></font></td>
                                            ...
                                            <tr>
                                                <td><font class="subTitleSmall"><asp:Label ID="Label3" runat="server" Text ="<%$Tokens:StringResource, admin.editfeed.FTPPassword %>" /></font></td>
                                            ...
                                            <tr>
                                                <td><font class="subTitleSmall"><asp:Label ID="Label4" runat="server" Text ="<%$Tokens:StringResource, admin.editfeed.FTPserver %>" /></font></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><font class="subTitleSmall"> <asp:Label ID="Label5" runat="server" Text ="<%$Tokens:StringResource, admin.editfeed.FTPPort %>" /></font></td>
                                            ...
                                            <tr>
                                                <td><font class="subTitleSmall"> <asp:Label ID="Label6" runat="server" Text ="<%$Tokens:StringResource, admin.editfeed.FTPFilename %>" /></font></td>
                                                <td>
                                        ...
                                        <asp:Button ID="btnExecFeed" runat="server" Text="<%$Tokens:StringResource, admin.editfeed.buttonExecuteFeed %>" CssClass="normalButtons" OnClick="btnExecFeed_OnClick" /><br /><br />
                                    </div>
                                </td>
                            </tr>
                        </table>
