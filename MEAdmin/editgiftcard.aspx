...
<asp:Content runat="server" ContentPlaceHolderID="bodyContentPlaceholder">
    <asp:Label runat="server" Text="Serial Number :" /><span style="color: Red;"><asp:Literal runat="server" id="ltCard"></asp:Literal></span>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr runat="server" id="PurchasedByCustomerIDTextRow">
                                                    ...
                                                    <td align="left" valign="middle">
                                                        ...
                                                        <asp:RequiredFieldValidator ValidationGroup="main" ErrorMessage="<%$Tokens:StringResource, admin.editgiftcard.Purchaser %>" ControlToValidate="txtCustomer" ID="reqCustID" SetFocusOnError="true" runat="server"></asp:RequiredFieldValidator> 
                                                    </td>
                                                </tr>                                                
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" valign="middle">
                                                                    ...
                                                                    <asp:Image ID="imgEmailTo" ImageUrl="~/App_Themes/Admin_Default/images/info.gif" ToolTip="<%$Tokens:StringResource,admin.editgiftcard.tooltip.imgEmailTo %>" runat="server" />
                                                                       <asp:RegularExpressionValidator id="RegularExpressionValidator1" runat="server" Display="None" ControlToValidate="txtEmailTo" EnableClientScript="false" ErrorMessage="<%$Tokens:StringResource, admin.editgiftcard.InvalidEmail %>" SetFocusOnError="true" ValidationExpression="^[a-zA-Z0-9][-\w\.\+]*@([a-zA-Z0-9][\w\-]*\.)+[a-zA-Z]{2,4}$"></asp:RegularExpressionValidator>
                                                                </td>
