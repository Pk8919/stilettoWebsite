    ...
    public partial class editgiftcard : AdminPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ltDate.Text = "<img src=\"" + AppLogic.LocateImageURL("~/App_Themes/Admin_Default/images/calendar.gif") + "\" style=\"cursor:hand;cursor:pointer;\" align=\"absmiddle\" id=\"f_trigger_s\">&nbsp;<small>(" + Localization.ShortDateFormat() + ")</small>";
