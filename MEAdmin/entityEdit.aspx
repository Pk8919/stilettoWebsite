                                                            ...
                                                            <asp:PlaceHolder ID="phAddress" runat="Server">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" valign="middle">
                                                                        ...
                                                                        <asp:RegularExpressionValidator ErrorMessage="Invalid Email Address Format (Main Tab)" ID="valRegExValEmail"
                                                                            ControlToValidate="txtEmail" runat="server" ValidationGroup="Main"
                                                                            ValidationExpression="^[a-zA-Z0-9][-\w\.\+]*@([a-zA-Z0-9][\w\-]*\.)+[a-zA-Z]{2,4}$"></asp:RegularExpressionValidator>
