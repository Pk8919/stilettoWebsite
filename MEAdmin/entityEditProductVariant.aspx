                                                            ...
                                                            <table cellpadding="0" cellspacing="1" border="0">
                                                                ...
                                                                <tr id="trRecurring" runat="server">
                                                                    ...
                                                                    <td align="left" valign="middle">
                                                                        ...
                                                                        <asp:Image runat="server" id="Image11" ImageUrl="~/App_Themes/Admin_Default/images/info.gif" border="0" ToolTip="<%$ Tokens:StringResource, admin.editproductvariant.tooltip.Recurring %>"
                                                                            style="cursor: normal;" />
                                                                    </td>
                                                                </tr>
                                                                <tr id="trRecurringIntervalDiv" runat="server">
                                                                    ...
                                                                    <td align="left" valign="middle">
                                                                        <asp:TextBox MaxLength="50" ID="txtRecurringIntervalMultiplier" runat="server" CssClass="singleShortest">1</asp:TextBox>
                                                                        &nbsp;*Interval Type:
