...
namespace AspDotNetStorefrontAdmin
{
    ...
    /// </summary>
    public partial class galleryimages : AdminPageBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            GalleryName = AppLogic.GetGalleryName(GalleryID, Localization.GetDefaultLocale());
        ...
        protected void LoadContent()
        {
            ...
            tmpS.Append("      <td><b>" + AppLogic.GetString("admin.galleryimages.SlideID", SkinID, LocaleSetting) + "</b></td>\n");
            tmpS.Append("      <td><b>" + AppLogic.GetString("admin.common.FileName", SkinID, LocaleSetting) + "</b></td>\n");
            tmpS.Append("      <td><b>" + AppLogic.GetString("admin.common.ImgTagSrc", SkinID, LocaleSetting) + "</b></td>\n");
            tmpS.Append("      <td><b>" + AppLogic.GetString("admin.common.Dimensions", SkinID, LocaleSetting) + "</b></td>\n");
            tmpS.Append("      <td><b>" + AppLogic.GetString("admin.common.SizeKB", SkinID, LocaleSetting) + "</b></td>\n");
            tmpS.Append("      <td align=\"center\"><b>" + AppLogic.GetString("admin.gallery.Image", SkinID, LocaleSetting) + "</b></td>\n");
            tmpS.Append("      <td align=\"center\"><b>" + AppLogic.GetString("admin.galleryimages.MoveUpDown", SkinID, LocaleSetting) + "</b></td>\n");
            tmpS.Append("      <td align=\"center\"><b>" + AppLogic.GetString("admin.common.Delete", SkinID, LocaleSetting) + "</b></td>\n");
            tmpS.Append("    </tr>\n");
            ...
            if (fArray.Count != 0)
            {
                ...
                {                    
                    ...
                    if (i != 0)
                    {
                        tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"" + AppLogic.GetString("admin.galleryimages.ToFirst", SkinID, LocaleSetting) + "\" name=\"MoveFirst_" + i.ToString() + "\" onClick=\"self.location = '" + AppLogic.AdminLinkUrl("galleryimages.aspx") + "?galleryid=" + GalleryID.ToString() + "&movefirstid=' + " + (i + 1).ToString() + ";\">");
                        tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"" + AppLogic.GetString("admin.galleryimages.MoveUp", SkinID, LocaleSetting) + "\" name=\"MoveUp_" + i.ToString() + "\" onClick=\"self.location = '" + AppLogic.AdminLinkUrl("galleryimages.aspx") + "?galleryid=" + GalleryID.ToString() + "&moveupid=' + " + (i + 1).ToString() + ";\">");
                    }
                    if (i != fArray.Count - 1)
                    {
                        tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"" + AppLogic.GetString("admin.galleryimages.Down", SkinID, LocaleSetting) + "\" name=\"MoveDown_" + i.ToString() + "\" onClick=\"self.location = '" + AppLogic.AdminLinkUrl("galleryimages.aspx") + "?galleryid=" + GalleryID.ToString() + "&movedownid=' + " + (i + 1).ToString() + ";\">");
                        tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"" + AppLogic.GetString("admin.galleryimages.ToLast", SkinID, LocaleSetting) + "\" name=\"MoveLast_" + i.ToString() + "\" onClick=\"self.location = '" + AppLogic.AdminLinkUrl("galleryimages.aspx") + "?galleryid=" + GalleryID.ToString() + "&movelastid=' + " + (i + 1).ToString() + ";\">");
                    }
                    tmpS.Append("</td>\n");
                    tmpS.Append("<td align=\"center\">");
                    tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"" + AppLogic.GetString("admin.common.Delete", SkinID, LocaleSetting) + "\" name=\"Delete_" + i.ToString() + "\" onClick=\"DeleteImage(" + (i + 1).ToString() + ")\">");
                    tmpS.Append("</td>\n");
                    tmpS.Append("</tr>\n");
                }
            }
            ...
            tmpS.Append("{\n");
            tmpS.Append("if(confirm('" + String.Format(AppLogic.GetString("admin.galleryimages.ConfirmDelete", SkinID, LocaleSetting),"'+ name"));
            tmpS.Append("{\n");
            tmpS.Append("self.location = '" + AppLogic.AdminLinkUrl("galleryimages.aspx") + "?galleryid=" + GalleryID.ToString() + "&deleteid=' + name;\n");
            tmpS.Append("}\n");
            tmpS.Append("}\n");
            tmpS.Append("</SCRIPT>\n");
