...
namespace AspDotNetStorefrontAdmin
{
    ...
    public partial class importProductPricing : AdminPageBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            {
                lblbreadcrumb.Text = AppLogic.GetString("admin.importProductPricing.ImportFromExcel", SkinID, LocaleSetting);
                ltResult.Text = (AppLogic.GetString("admin.importProductPricing.XMLNotSupported", SkinID, LocaleSetting));
            }
