...
namespace AspDotNetStorefrontAdmin
{
    public partial class wizard : AdminPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "rowScript", "setAlternatingRows();", true);
        ...
        public void BuildPaymentMethodList(string payMethod)
        {
            ...
            cbxMicroPay.Checked = paymentMethods.Contains("MICROPAY".ToLowerInvariant()) || ("MICROPAY".Equals(AppLogic.ro_PMMicropay, StringComparison.InvariantCultureIgnoreCase) && AppLogic.AppConfigBool("Micropay.Enabled"));
