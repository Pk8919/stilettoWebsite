<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShippingAddressEdit.ascx.cs"
    Inherits="VortxControls_ShippingAddressEdit" %>
    ...
    <ContentTemplate>
        <table cellspacing="0" cellpadding="0" id="ShipAddressTable" class="shipAddressWrap"
            ...
            <tr id="PanelDynamicZip" runat="server">
                ...
                <td class="addressInputCell">
                    <asp:TextBox runat="server" ID="ShipZip" OnTextChanged="ShipZip_OnTextChanged" />
            ...
            <tr id="PanelDynamicCityAndState" runat="server">
                ...
                <td class="addressInputCell">
                    <asp:DropDownList runat="server" ID="ShipZipCityState" Visible="true" AutoPostBack="true"
                        OnSelectedIndexChanged="ShipZipCityState_OnChanged" OnDataBound="ShipZipCityState_OnDataBound" />
                    <asp:Label runat="server" ID="EnterZip" CssClass="OPEmphasize" Text='<%# StringResourceProvider.GetString("smartcheckout.aspx.23") %>' />
                </td>
            </tr>
                ...
                <td colspan="2">
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="addressInputCell">
                                <asp:DropDownList runat="server" ID="ShipOtherState" Visible="true" OnDataBound="ShipOtherState_OnDataBound"
                                    MaxLength="99" />
                            </td>
                        </tr>
                    </table>
        ...
        <div class="nextStepWrap">
            ...
            <asp:Button ID="ButtonSaveAddress" Text='<%# StringResourceProvider.GetString("smartcheckout.aspx.117") %>' runat="server" OnClick="SaveAddress_Click"
                CssClass="OPButton" />
