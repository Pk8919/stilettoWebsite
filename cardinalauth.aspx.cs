    ...
    public partial class cardinalauth : System.Web.UI.Page
    {
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (ThisCustomer.ThisCustomerSession["Cardinal.ACSURL"].Length == 0)
            {
                Response.Write("<HTML>\n");
                Response.Write("<BODY>\n");
                Response.Write("<center>" + AppLogic.GetString("cardinalauth.aspx.1", 1, Localization.GetDefaultLocale()) + "</center>\n");
                Response.Write("</BODY>\n");
                Response.Write("</HTML>\n");
            }
            else
            {
                ...
                Response.Write("	<h1>" + AppLogic.GetString("cardinalauth.aspx.2", 1, Localization.GetDefaultLocale()) + "</h1>\n");
                Response.Write("	<h2>" + AppLogic.GetString("cardinalauth.aspx.3", 1, Localization.GetDefaultLocale()) + "<br/></h2>\n");
                Response.Write("	<h3>" + AppLogic.GetString("cardinalauth.aspx.4", 1, Localization.GetDefaultLocale()) + "</h3>\n");
                Response.Write("	</font>\n");
                Response.Write("	<input type=\"submit\" value=\"" + AppLogic.GetString("cardinalauth.aspx.5", 1, Localization.GetDefaultLocale()) + "\">\n");
                Response.Write("	</center>\n");
                Response.Write("</noscript>\n");
