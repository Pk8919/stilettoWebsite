...
namespace AspDotNetStorefront
{
    ...
    public partial class checkout1 : SkinBase
    {
        ...
        private void ProcessPayment(string PaymentMethod)
        {
            ...
            if (PM == AppLogic.ro_PMCreditCard)
            {
                bool CardinalAllowed = AppLogic.ProductIsMLExpress() == false && AppLogic.AppConfigBool("CardinalCommerce.Centinel.Enabled") && !(cart.Total(true) == Decimal.Zero && AppLogic.AppConfigBool("SkipPaymentEntryOnZeroDollarCheckout"));
