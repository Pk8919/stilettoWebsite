                        ...
                        <table cellspacing="0" cellpadding="1" width="90%" border="0" id="table1">
                            <tr>
                                <td valign="top" width="45%">
                                    <asp:Label ID="Label6" runat="server" Text="<%$ Tokens:StringResource,checkoutanon.aspx.12 %>" Font-Bold="true"></asp:Label><br /><br />
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Tokens:StringResource,checkoutanon.aspx.3 %>" /><br /><br />
                                    <table cellspacing="0" cellpadding="0" width="100%" border="0" id="table2">
                                        <tr>
                                            <td><asp:Label ID="Label2" runat="server" Text="<%$ Tokens:StringResource,checkoutanon.aspx.4 %>" Font-Bold="true" /></td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label3" runat="server" Text="<%$ Tokens:StringResource,checkoutanon.aspx.5 %>" Font-Bold="true" /></td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <asp:Button ID="btnSignInAndCheckout" CssClass="UpdateCartButton" Text="<%$ Tokens:StringResource,checkoutanon.aspx.13 %>" runat="server" ValidationGroup="Group1" CausesValidation="true" OnClick="btnSignInAndCheckout_Click" />
                                                <br /><br />
                                                <asp:Label ID="Label5" runat="server" Text="<%$ Tokens:StringResource,checkoutanon.aspx.7 %>" Font-Bold="true" /><br /><br />
                                ...
                                <td valign="top" width="45%">
                                    <asp:Label ID="Label7" runat="server" Text="<%$ Tokens:StringResource,checkoutanon.aspx.9 %>" Font-Bold="true" /><br /><br />
                                    <asp:Button ID="RegisterAndCheckoutButton" CssClass="UpdateCartButton" Text="<%$ Tokens:StringResource,checkoutanon.aspx.14 %>" runat="server" CausesValidation="false" OnClick="RegisterAndCheckoutButton_Click"  />
                                    <br /><br />
                                    ...
                                    <asp:Panel runat="Server" ID="PasswordOptionalPanel" Visible="false">
                                        <br /><br />
                                        <asp:Label ID="Label8" runat="server" Text="<%$ Tokens:StringResource,checkoutanon.aspx.10 %>" Font-Bold="true" /><br /><br />
                                        <asp:Label ID="Label9" runat="server" Text="<%$ Tokens:StringResource,checkoutanon.aspx.11 %>" /><br /><br />
                                        <asp:Button ID="Skipregistration" CssClass="UpdateCartButton" Text="<%$ Tokens:StringResource,checkoutanon.aspx.15 %>" runat="server" CausesValidation="false" OnClick="Skipregistration_Click" />
                                    </asp:Panel>
                                </td>
                            </tr>
                        </table>
                        ...
                        <tbody>
                            <tr valign="top">
                                <td align="left" width="90%">
                                    <asp:Label ID="Label10" runat="server" Text="<%$ Tokens:StringResource,signin.aspx.22 %>" Font-Bold="true" ForeColor="red"></asp:Label><br/><br/>
                                        ...
                                        <tbody>
                                            ...
                                            <tr valign="baseline">
                                                <td valign="middle" align="right">
                                                    <asp:Label ID="Label14" runat="server" Text="<%$ Tokens:StringResource,signin.aspx.10 %>"></asp:Label>
                                                </td>
                                                <td valign="middle" align="left">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="Group3" ErrorMessage="<%$ Tokens:StringResource,signin.aspx.3 %>" ControlToValidate="CustomerEmail"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="middle" align="right">
                                                ...
                                                <td valign="middle" align="left">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ValidationGroup="Group3" ErrorMessage="<%$ Tokens:StringResource,signin.aspx.4 %>" ControlToValidate="OldPassword"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="middle" align="right">
                                                ...
                                                <td valign="middle" align="left">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ValidationGroup="Group3" ErrorMessage="<%$ Tokens:StringResource,signin.aspx.4 %>" ControlToValidate="NewPassword"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="middle" align="right">
                                                ...
                                                <td valign="middle" align="left">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ValidationGroup="Group3" ErrorMessage="<%$ Tokens:StringResource,signin.aspx.4 %>" ControlToValidate="NewPassword2"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>                                        
                                        </tbody>
                                    </table>
