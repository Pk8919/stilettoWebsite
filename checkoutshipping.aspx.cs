...
namespace AspDotNetStorefront
{
    ...
    public partial class checkoutshipping : SkinBase
    {
        ...
        public void btnNewShipAddr_OnClick(object sender, System.EventArgs e)
        {
            ...
            {
                ctrlShippingMethods.ErrorMessage += "<br /><br />" + AppLogic.GetString("checkoutshipping.aspx.23", SkinID, ThisCustomer.LocaleSetting) + "<br /><br />";
                ...
                ctrlShippingMethods.ErrorMessage += "<br />";
        ...
        private void InitializePageContent()
        {
			...
			if (!ThisCustomer.IsRegistered)
				((RectangleHotSpot) checkoutheadergraphic.HotSpots[1]).NavigateUrl = "createaccount.aspx?checkout=true&skipreg=true";
