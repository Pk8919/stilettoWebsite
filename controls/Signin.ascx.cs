    ...
    public partial class Signin : System.Web.UI.UserControl
    {
        ...
        protected void btnChgPwd_Click(object sender, EventArgs e)
        {
            ...
            if (ThisCustomer.IsRegistered)
            {
                ...
                {
                    lblPwdChgErr.Text += "<br/>" + AppLogic.GetString("signin.aspx.29", m_SkinID, ThisCustomer.LocaleSetting);
            ...
            {
                lblPwdChgErr.Text = "<br/><br/>" + AppLogic.GetString("lat_signin_process.aspx.1", m_SkinID, ThisCustomer.LocaleSetting);
                lblPwdChgErr.Visible = true;
                return;
            }
        ...
        private Boolean ValidatePassword(String newPassword)
        {
            ...
            {
                lblPwdChgErr.Text = "<br/><br/>" + AppLogic.GetString("lat_signin_process.aspx.3", m_SkinID, ThisCustomer.LocaleSetting);
                lblPwdChgErr.Visible = true;
                return false;
            }
            ...
            if (!ThisCustomer.Active)
            {
                lblPwdChgErr.Text = "<br/><br/>" + AppLogic.GetString("lat_signin_process.aspx.2", m_SkinID, ThisCustomer.LocaleSetting);
                lblPwdChgErr.Visible = true;
                return false;
            }
        ...
        private bool ValidateNewPassword()
        {
            ...
            if (tbNewPassword.Text == tbNewPassword2.Text)
            {
                try
                {
                    ...
                    if (!valPwd)
                    {
                        lblPwdChgErr.Text = "<br/><br/>" + AppLogic.GetString("account.aspx.7", m_SkinID, ThisCustomer.LocaleSetting);
                    }
                }
                catch
                {
            ...
            {
                lblPwdChgErr.Text = "<br/><br/>" + AppLogic.GetString("signin.aspx.32", m_SkinID, ThisCustomer.LocaleSetting);
            }
            return valPwd;
        }
