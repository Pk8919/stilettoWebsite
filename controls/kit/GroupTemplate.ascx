...
<div class="kit_group">
    ...
    <asp:Panel ID="pnlGroupName" runat="server" CssClass="kit_groupName" >
    ...
    <%--<asp:UpdatePanel ID="pnlUpdateGroupTemplate" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <ContentTemplate>--%>       
        
        
        <asp:Panel ID="pnlGroupContent" runat="server" CssClass="kit_groupContent" >
        
            <asp:Panel ID="pnlGroupDescription" runat="server" CssClass="kit_groupDescription"  
                Visible='<%# KitGroup.HasDescription || KitGroup.HasImage %>'
                Height="0" >
                
                <asp:Image ID="imgGroup" runat="server" CssClass="kit_group_image" 
