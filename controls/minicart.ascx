            ...
            <div id="divMiniCart">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server"
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="pnlMinicartHeader" runat="server" CssClass="miniCartCollapseHeaderPanel">
                        ...
                        <asp:Panel ID="pnlMinicartControl" runat="server" CssClass="miniCartCollapseBody" Height="0" >
