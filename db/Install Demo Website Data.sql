...
--INSERT [dbo].Category(CategoryID,Name,SEName,Published,AllowSectionFiltering,AllowManufacturerFiltering,AllowProductTypeFiltering) values(5,'Microwave Oven','microwave-oven',1,0,0,0);
...
--INSERT [dbo].Category(CategoryID,Name,SEName,Published,AllowSectionFiltering,AllowManufacturerFiltering,AllowProductTypeFiltering) values(8,'Adult Bikes','adult-bikes',1,0,0,0);
...
--INSERT [dbo].Category(CategoryID,Name,SEName,Published,AllowSectionFiltering,AllowManufacturerFiltering,AllowProductTypeFiltering) values(26,'Lamb, Poultry & Sausage','lamb-poultry-sausage',1,0,0,0);
...
INSERT [dbo].Category(CategoryID,Name,SEName,Published,AllowSectionFiltering,AllowManufacturerFiltering,AllowProductTypeFiltering) values(30,'Magazine Subscription','magazine-subscription',1,0,0,0);
...
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(1,'Sony','Sony Computer Entertainment Inc.',1,1);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(2,'Nintendo','Nintendo Company Ltd',1,2);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(3,'Megatech','Megatech International',1,3);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(4,'Kettler','Kettler',1,4);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(5,'CAT','Caterpillar',1,5);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(6,'Step2','Step2 Company',1,6);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(7,'Microsoft','Microsoft Corporation',1,7);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(8,'Whirlpool','Whirlpool Corporation',1,8);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(9,'Razor','Razor USA LLC',1,9);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(10,'Micro','Micro',1,10);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(11,'HP','Hewlett-Packard Development Company',1,11);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(12,'Dell','Dell Company',1,12);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(13,'Joseph Abboud','JA Apparel Corporation',1,13);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(14,'Lexmark','Lexmark International',1,14);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(15,'Reed & Barton','Reed & Barton Company',1,15);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(16,'Barbour','J. Barbour & Sons Ltd.',1,16);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(17,'Centrum','Wyeth',1,17);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(18,'One A Day','Bayer Healthcare',1,18);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(19,'Nature Made','Pharmavite',1,19);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(20,'Lasco','Lasco Bathware',1,20);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(21,'Seagate','Seagate Technology',1,21);
INSERT [dbo].Affiliate(AffiliateID,Name,Company,TrackingOnly,DisplayOrder) values(22,'Kirkland Signature','Costco',1,21);
...
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(176, 'Cosmopolitan Magazine','2 year magazine subscription. 24 issues. fsCosmopolitan is the life-stylist for millions of fun fearless females who want to be the best they can be in every area of their lives.  Every month, Cosmo delivers a fresh and honest focus on love & relationships, life & work, health & fitness, beauty & fashion, your favorite celebs and much more!',1,1,'01-00176',1,1)
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(177, 'Town & Country Magazine','2 year magazine subscription. 24 issues. Town & Country is a magazine for people with trendsetting style and panache for life. People whose tastes in fashion, home décor, travel, and culture set the standard and who demand and expect nothing but the best. Each month Town & Country brings all these things to you and much more.',1,1,'01-00177',1,1)
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(178, 'Country Living Magazine','2 year magazine subscription 24 issues. Step into the warm, casual comfort of country style – no matter where you live.  Each issue brings a country approach to home decorating, cooking and entertaining, gardening and landscaping, home building, travel and other leisure activities.',1,1,'01-00178',1,1)
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(179, 'House Beautiful Magazine','2 year magazine subscription 24 issues. House Beautiful will help you discover and create the beautiful house you have in you.  Each issue gives you the inspiration, ideas, expertise, and the resources to help you better understand what will make you happy in you home.',1,1,'01-00179',1,1)
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(180, 'Popular Mechanics Magazine','2 year magazine subscription 24 issues. Each issue of Popular Mechanics brings you the latest innovations in science and technology. Popular Mechanics also educates with informative “how-to” and “how-it-works” stories on automotive, the home, digital technology and more.',1,1,'01-00180',1,1)
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(181, 'Good Housekeeping Magazine','2 year magazine subscription 24 issues. For today’s busy mothers, Good Housekeeping is the source for the best ideas, advice and inspiration in the areas that matter to you most: health, family, food, home and taking care of yourself.  Plus, through the Good Housekeeping Institute and the Good Housekeeping Seal, the magazine offers triple tested advice that no other magazine can match on staying healthy, buying wisely and looking great.',1,1,'01-00181',1,1)
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(182, 'Harper’s Bazaar Magazine','2 year magazine subscription 24 issues. No magazine helps define personal style quite like Harper’s Bazaar.  Bold new looks.  Timeless classics.  Casual chic.  Smart seasonal ensembles.  Glamorous formal wear.  Harper’s Bazaar reveals the secrets, styles and accessories that’ll keep you looking amazingly radiant at any age.',1,1,'01-00182',1,1)
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(183, 'Marie Claire Magazine','2 year magazine subscription 24 issues. Marie Claire is the fashion magazine with character, substance and depth for women with a point of view, an opinion and a sense of humor.  The Marie Claire reader is a sexy, stylish, confident woman who is never afraid to make intelligence a part of her wardrobe. ',1,1,'01-00183',1,1)
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(184, 'Redbook Magazine','2 year magazine subscription 24 issues. Each issue of Redbook offers exciting, provocative features that address all aspects of your life—everything from inspiring fashion and beauty stories to creative ideas on how to keep your marriage fresh, to strategies on how to balance home and career demands.',1,1,'01-00184',1,1)
INSERT [dbo].Product(ProductID,Name,Description,ProductTypeID,SalesPromptID,SKU,Published,ShowInProductBrowser) values(185, 'Seventeen Magazine','2 year magazine subscription 24 issues. Seventeen magazine is for the “Actionista” – go-to girls like you who turn ideas into actions.  Each month Seventeen delivers the latest on what matters to you most – your fashions, your friends and your futures.',1,1,'01-00185',1,1)
...
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(176,30,176);
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(177,30,177);
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(178,30,178);
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(179,30,179);
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(180,30,180);
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(181,30,181);
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(182,30,182);
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(183,30,183);
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(184,30,184);
INSERT [dbo].ProductCategory(ProductID,CategoryID,DisplayOrder) values(185,30,185);
...
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(176,13,175);
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(177,13,175);
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(178,13,175);
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(179,13,175);
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(180,13,180);
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(181,13,181);
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(182,13,182);
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(183,13,183);
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(184,13,184);
INSERT [dbo].ProductSection(ProductID,SectionID,DisplayOrder) values(185,13,185);
...
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(176,167,1,'','','',59.99,10,'7.46');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(177,168,1,'','','',59.99,10,'7.46');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(178,169,1,'','','',149.99,10,'7.46');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(179,170,1,'','','',1599.99,10,'24.89');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(180,171,1,'','','',149.99,10,'10.12');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(181,172,1,'','','',114.99,10,'15.23');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(182,173,1,'','','',109.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(183,174,1,'','','',99.99,10,'1.56');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(184,175,1,'','','',79.99,10,'2.58');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(185,176,1,'','','',23.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(186,177,1,'','','',15.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(187,178,1,'','','',13.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(188,179,1,'','','',13.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(189,180,1,'','','',13.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(190,181,1,'','','',11.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(191,182,1,'','','',11.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(192,183,1,'','','',11.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(193,184,1,'','','',11.99,10,'.98');
INSERT [dbo].ProductVariant(VariantID,ProductID,IsDefault,Name,Description,SKUSuffix,Price,Inventory,Weight) values(194,185,1,'','','',11.99,10,'.98');
...
UPDATE [dbo].Product SET RelatedProducts = '176,177,178,179,180,181,182,183,184,185' WHERE ProductID in (select ProductID from [dbo].ProductCategory where CategoryID = 30)
