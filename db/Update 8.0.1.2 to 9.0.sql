...
GO
ALTER TABLE [dbo].[ZipTaxRate] ADD
[CountryID] [int] NOT NULL CONSTRAINT [DF__ZipTaxRat__Count__66161CA2] DEFAULT ((-1))
...
-- ADD NEW APPCONFIGS
INSERT INTO [dbo].[AppConfig] ([Name], [Description], [ValueType], [AllowableValues], [GroupName], [SuperOnly], [Hidden]) VALUES (N'AddInDir', N'The subdirectory in which you have addins.', N'string', NULL, N'SETUP', 1, 0)
INSERT INTO [dbo].[AppConfig] ([Name], [Description], [ValueType], [AllowableValues], [GroupName], [SuperOnly], [Hidden]) VALUES (N'AddIns.Enabled', N'You must turn this on in order to use AddIns on your site.  Unless you have a specific addin to install you should leave this set to false.', N'boolean', NULL, N'SETUP', 1, 0)
...
UPDATE [dbo].[AppConfig] SET [ConfigValue]=N'AddIns' WHERE [Name]=N'AddInDir'
UPDATE [dbo].[AppConfig] SET [ConfigValue]=N'FALSE' WHERE [Name]=N'AddIns.Enabled'
