...
namespace AspDotNetStorefront
{
    ...
    public partial class giftregistry : SkinBase
    {
        ...
        private void InitializePageContent()
        {
            ...
            giftregistry6_gif.ImageUrl = AppLogic.LocateImageURL("App_Themes/skin_" + SkinID.ToString() + "/images/giftregistry6.gif");
            ...
            if (GiftRegistryGUID.Length == 0)
            {
                if (!ThisCustomer.HasCustomerRecord)
                {
                    ...
                    giftregistry_gif1.ImageUrl = AppLogic.LocateImageURL("App_Themes/skin_" + SkinID.ToString() + "/images/giftregistry.gif");
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        giftregistry2_gif.ImageUrl = AppLogic.LocateImageURL("App_Themes/skin_" + SkinID.ToString() + "/images/giftregistry2.gif");
                        if (!IsPostBack)
                        {
                    ...
                    if (ThisCustomer.IsRegistered && !cart.IsEmpty())
                    {
                        ...
                        giftregistry7_gif.ImageUrl = AppLogic.LocateImageURL("App_Themes/skin_" + SkinID.ToString() + "/images/giftregistry7.gif");
                    ...
                    //giftregistry_gif.ImageUrl = AppLogic.LocateImageURL("App_Themes/skin_" + SkinID.ToString() + "/images/giftregistry.gif");
                    //tblGiftRegistryItemsBox.Attributes.Add("style", AppLogic.AppConfig("BoxFrameStyle"));
                    //litCartItems.Text = String.Empty; //cart.DisplayItems(false, ThisCustomer, true);  TBD!! Must be changed to displayitems control!
            ...
            else
            {
                ...
                if (RegistryOwnerCustomerID != 0)
                {
                    ...
                    //giftregistry5_gif.ImageUrl = AppLogic.LocateImageURL("App_Themes/skin_" + SkinID.ToString() + "/images/giftregistry5.gif");
                    ...
                    //litTheirRegistryItems.Text = String.Empty; //ViewingRegistryCart.DisplayItems(true, ThisCustomer, true); TBD!! Must be changed to DisplayItems Control
                }
                else
                {
        ...
        private void MoveGiftRegistryItemToCart(string PassedGiftRegistryGUID, int MoveID, int cartRecordID)
        {
            ...
            if (PassedGiftRegistryGUID.Length != 0 && MoveID != 0)
            {
                ...
                if (RegistryOwnerCustomerID != 0)
                {
                    ...
                    else
                    {
                        ...
                        //JH -- KitCart and CustomCart don't have a StoreID Column
        ...
        protected void ctrlMyRegistry_MoveToShoppingCartInvoked(object sender, ItemEventArgs e)
        {
            ...
            int MoveID = e.ID;
            MoveGiftRegistryItemToCart(ThisCustomer.GiftRegistryGUID, MoveID, cartRecordId);
        }
        ...
        protected void ctrlTheirRegistry_MoveToShoppingCartInvoked(object sender, ItemEventArgs e)
        {
            int cartRecordId = e.ID;
            int MoveID = e.ID;
            MoveGiftRegistryItemToCart(GiftRegistryGUID, MoveID, cartRecordId);
        }
