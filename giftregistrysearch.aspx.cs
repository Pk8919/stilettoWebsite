...
namespace AspDotNetStorefront
{
    ...
    public partial class giftregistrysearch : SkinBase
    {
        ...
        private void InitializePageContent()
        {
            ...
            giftregistry3_gif.ImageUrl = AppLogic.LocateImageURL("App_Themes/skin_" + SkinID.ToString() + "/images/giftregistry3.gif");
        ...
        private void DoSearch(string sql)
        {
            ...
            else
            {
                ...
                SearchResults.Text = "<br/><br/>" + AppLogic.GetString("giftregistrysearch.aspx.10", SkinID, ThisCustomer.LocaleSetting) + "<br/><br/>";
            }
        }
