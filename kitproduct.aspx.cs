...
namespace AspDotNetStorefront
{
    public partial class kitproduct : SkinBase
    {
        ...
        {
            litKitUpsell.Text = "<br clear=\"all\"/>" + AppLogic.GetUpsellProductsBoxExpanded(ProductID, 100, true, String.Empty, AppLogic.AppConfig("RelatedProductsFormat").Equals("GRID", StringComparison.InvariantCultureIgnoreCase), ThisCustomer.SkinID, ThisCustomer);
        }
