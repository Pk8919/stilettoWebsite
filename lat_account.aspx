                    ...
                    <tr>
                        <td valign="top" align="left">
                            <asp:Panel ID="pnlBeforeSignup" runat="server" Visible="true">
                                ...
                                <table cellspacing="0" cellpadding="1" width="171" border="0" style="">
                                    <tr>
                                        <td class="AffiliateHeaderTd" height="18">&nbsp;<asp:Literal ID="Literal5" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.28 %>" /></td>
                                    </tr>
                                            ...
                                            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                                                <tr>
                                                    <td valign="top" align="left" width="100%" class="AffiliateLinks">
                                                         &bull; <a href="lat_account.aspx"><asp:Literal ID="Literal1" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.27 %>" /></a><br />
                                                         &bull; <a href="lat_driver.aspx?topic=affiliate_linking"><asp:Literal ID="Literal2" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.26 %>" /></a><br/>
                                                         &bull; <a href="lat_driver.aspx?topic=affiliate_faq"><asp:Literal ID="Literal3" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.25 %>" /></a><br />
                                                         &bull; <asp:HyperLink ID="AskAQuestion" runat="server" Text="<%$ Tokens:StringResource,lataccount.aspx.24 %>"></asp:HyperLink><br />
                                                         &bull; <a href="lat_driver.aspx?topic=affiliate_terms"><asp:Literal ID="Literal4" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.23 %>" /></a>
                                                     </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <asp:Panel ID="pnlAfterSignup" runat="server" Visible="false">
                                <table cellSpacing="0" cellPadding="1" width="171" bgColor="#AAAAAA" border="0">
                                    <tr>
                                      <td bgcolor="#AAAAAA" height="18"><b style="color: #ffffff" class="small">&nbsp;<asp:Literal ID="Literal6" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.22 %>" /></b></td>
                                    </tr>
                                    <tr valign="middle" align="center">
                                        <td>
                        ...
                        <td width="100%" align="left" valign="top">
                            <table cellpadding="0" cellspacing="0" align="center" width="400">
                                ...
                                <tr><td><b><asp:Literal ID="Literal7" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.29 %>" /></b><br /><br /></td></tr>
                                <tr>
                                    <td>
                                       ...
                                       <asp:Table ID="tblAccount" CellSpacing="0" CellPadding="2" Width="100%" runat="server">
                                                <asp:TableRow>
                                                    <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                                            ...
                                                            <asp:TableRow>
                                                                <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                                                    <table border="0" cellpadding="0" cellspacing="2" width="100%">
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal8" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.7 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal9" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.8 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal10" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.9 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal11" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.10 %>" /></td>

                                                                            <td width="70%">
                                                                                <asp:TextBox ID="AffPassword" TextMode="Password" Columns="37" maxlength="100" runat="server" ValidationGroup="signup" CausesValidation="true"></asp:TextBox><br /><asp:Literal ID="Literal184" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.34 %>" /> 
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal12" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.11 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal13" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.12 %>" /></td>

                                                                            <td width="70%"><asp:TextBox ID="Company" Columns="34" MaxLength="100" TextMode="singleLine"  runat="server" CausesValidation="false" /></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal14" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.13 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal141" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.14 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal15" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.15 %>" /></td>

                                                                            <td width="70%"><asp:TextBox ID="Suite" Columns="34" MaxLength="100" TextMode="singleLine"  runat="server" /></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal16" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.16 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal17" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.17 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal39" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.18 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal40" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.19 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal41" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.20 %>" /></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal42" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.21 %>" /></td>
                                                        ...
                                                        <div align="center">
                                                            <asp:Button ID="btnUpdate1" runat="server" Text="<%$ Tokens:StringResource,lataccount.aspx.1 %>" CausesValidation="true" ValidationGroup="signup" OnClick="btnUpdate1_Click" />
                                                        </div>
                                                        <br /><br />
                                                    </asp:TableCell>
                                                </asp:TableRow>
                                            ...
                                            <asp:Table ID="tblOnlineInfo" CellSpacing="0" CellPadding="2" Width="100%" runat="server">
                                                <asp:TableRow>
                                                    <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                                        ...
                                                        <asp:Table ID="tblOnlineInfoBox" CellSpacing="0" CellPadding="4" Width="100%" runat="server">
                                                            <asp:TableRow>
                                                                <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                                                    <table border="0" cellpadding="0" cellspacing="2" width="100%">
                                                                        <tr>
                                                                            <td width="100%" colspan="2"><b><asp:Literal ID="Literal22" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.5 %>" /><br />
                                                                            <br />
                                                                            <asp:Literal ID="Literal23" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.6 %>" /></b></td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td width="30%"><asp:Literal ID="Literal24" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.4 %>" /></td>

                                                                            <td width="60%"><asp:TextBox ID="WebSiteName" runat="server" Columns="35" MaxLength="100"></asp:TextBox></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td width="40%"><asp:Literal ID="Literal25" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.3 %>" /></td>

                                                                            <td width="60%"><asp:TextBox ID="WebSiteDescription" runat="server" Columns="35" MaxLength="500"></asp:TextBox></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td width="40%"><asp:Literal ID="Literal26" runat="server" Mode="PassThrough" Text="<%$ Tokens:StringResource,lataccount.aspx.2 %>" /></td>
                                                        ...
                                                        <div align="center">
                                                            <asp:Button ID="btnUpdate2" runat="server" Text="<%$ Tokens:StringResource,lataccount.aspx.1 %>" CausesValidation="true" ValidationGroup="signup" OnClick="btnUpdate2_Click"  />
                                                        </div>
                                                        <br /><br />
                                                    </asp:TableCell> 
                                                </asp:TableRow> 
