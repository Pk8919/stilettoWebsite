    ...
    public partial class lat_account : SkinBase
    {
        ...
        private void ProcessAccountUpdate()
        {
            ...
            if (Page.IsValid && a.AffiliateID != -1)
            {
                ...
                {
                    lblErrMsg.Text = "<p><b>ERROR: There was an unknown error in updating your new account record. Please <a href=\"contactus.aspx\">contact a service representative</a> for assistance.<br/><br/></b></p>";
                }
