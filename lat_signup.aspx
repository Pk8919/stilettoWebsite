                                    ...
                                    <table cellspacing="0" cellpadding="4" width="100%" border="0">
                                        <tr>
                                            <td valign="top" align="left" width="100%" class="AffiliateLinks">
                                                ...
                                                <asp:HyperLink runat="server" NavigateUrl="<%$ Tokens:TopicLink, affiliate %>" Text=". Read more" />.
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table cellspacing="0" cellpadding="4" width="100%" border="0">
                                        <tr>
                                            <td valign="top" align="left" width="100%" class="AffiliateLinks">
                                                ...
                                                &bull; <asp:HyperLink runat="server" NavigateUrl="<%$ Tokens:TopicLink, affiliate_faq %>" Text="<%$ Tokens:TopicTitle, affiliate_faq %>" /><br />
                                                &bull;
