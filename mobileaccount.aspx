            ...
            <asp:PlaceHolder runat="server" id="pnlBillingAddressMP">
                <div data-role="collapsible">
	                ...
	                <div class="accordion_child">
                        ...
                        <br /><b><asp:HyperLink ID="lnkAddBillingAddress" runat="server"></asp:HyperLink></b>
                    </div>
	            </div>
            </asp:PlaceHolder>
                                ...
                                <asp:Repeater ID="orderhistorylist" runat="server">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            Notes:
                                               <%#"&nbsp;" + GetCustSvcNotes(DataBinder.Eval(Container.DataItem, "CustomerServiceNotes").ToString()) + "&nbsp;"%><br />
                                               <%#GetReorder(DataBinder.Eval(Container.DataItem, "OrderNumber").ToString(), DataBinder.Eval(Container.DataItem, "RecurringSubscriptionID").ToString()).Replace("<br/>", "")%>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
