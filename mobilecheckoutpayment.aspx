...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="PageContent">
    ...
    <ul data-role="listview">
        <li class="group" data-role="list-divider">
            ...
            <asp:ValidationSummary DisplayMode="List" ID="valsumCreditCard" ShowMessageBox="false" runat="server" ShowSummary="true" ValidationGroup="creditcard" Font-Bold="true"/>
            <asp:ValidationSummary DisplayMode="List" ID="valsumEcheck" ShowMessageBox="false" runat="server" ShowSummary="true" ValidationGroup="echeck" Font-Bold="true"/>
        ...
        <li>
           ...
           <asp:Panel ID="pnlPOPane" runat="server" Visible="false" CssClass="InfoMessageBox">
            ...
            <asp:Panel ID="pnlContCheckout" runat="server" Visible="true" HorizontalAlign="Center">
                    <br/><asp:Button ID="btnContCheckout" runat="server" class="PaymentPageContinueCheckoutButton action"
