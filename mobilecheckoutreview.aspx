            ...
            <asp:Literal runat="server" id="CheckoutHeader"></asp:Literal>
                ...
                <div data-role="collapsible-set">
	                <div data-role="collapsible" data-collapsed="false">
	                    <h3><asp:Label ID="paymentHeader" Text="<%$ Tokens:StringResource,Mobile.checkoutReview.PaymentHeader %>" runat="server"></asp:Label></h3>
	                ...
	                <div data-role="collapsible">
	                    <h3><asp:Label ID="Label1" Text="<%$ Tokens:StringResource,Mobile.checkoutReview.BillingHeader %>" runat="server"></asp:Label></h3>
	                    <div class="accordion_child">                        
                            <asp:Literal ID="litBillingAddress" runat="server" Mode="PassThrough"></asp:Literal>
                        </div>
	                </div>
	                <div data-role="collapsible">
	                    <h3><asp:Label ID="shippingHeader" Text="<%$ Tokens:StringResource,Mobile.checkoutReview.ShippingHeader %>" runat="server"></asp:Label></h3>
	                ...
	                <div data-role="collapsible">
	                    <h3><asp:Label ID="orderHeader" Text="<%$ Tokens:StringResource,Mobile.checkoutReview.OrderHeader %>" runat="server"></asp:Label></h3>
