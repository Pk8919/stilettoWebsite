...
<asp:Panel ID="pnlEmailToFriend" runat="server" Visible="false" DefaultButton="btnSubmit">
    <ul data-role="listview">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td class="ProductNameText">
                        <asp:Label ID="emailproduct_aspx_4" runat="server"></asp:Label><br />
                        <br />
                    </td>
                </tr>
            </table>
        ...
        <li>
            ...
            <asp:TextBox ID="txtToAddress" runat="server" MaxLength="75" style="width:85%;" CausesValidation="true"></asp:TextBox><br />
            <asp:RequiredFieldValidator ID="reqToAddress" ControlToValidate="txtToAddress" runat="server"
                Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="regexToAddress" ControlToValidate="txtToAddress"
                Display="Dynamic" runat="server" ValidationExpression="^[a-zA-Z0-9][-\w\.\+]*@([a-zA-Z0-9][\w\-]*\.)+[a-zA-Z]{2,4}$"></asp:RegularExpressionValidator><br />
            <asp:Label ID="emailproduct_aspx_22" runat="server" Font-Bold="true"></asp:Label><br />
            <asp:TextBox ID="txtMessage" runat="server" TextMode="MultiLine" style="width:85%;" Rows="7"></asp:TextBox><br />
            <br />
            <asp:Label ID="emailproduct_aspx_15" runat="server" Font-Bold="true"></asp:Label><br />
            <asp:TextBox ID="txtFromAddress" MaxLength="75" runat="server" style="width:85%;" CausesValidation="true"></asp:TextBox><br />
            ...
            <asp:RegularExpressionValidator ID="regexFromAddress" ControlToValidate="txtFromAddress"
                Display="Dynamic" runat="server" ValidationExpression="^[a-zA-Z0-9][-\w\.\+]*@([a-zA-Z0-9][\w\-]*\.)+[a-zA-Z]{2,4}$"></asp:RegularExpressionValidator><br />
            <br />
