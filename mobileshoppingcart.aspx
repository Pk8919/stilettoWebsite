...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="PageContent">
        <ul id="MPShoppingCartUL" data-role="listview">
            ...
            <li runat="server" id="AlternativeCheckouts" class="mpAltCheckout">
                <span runat="server" id="GoogleCheckoutSpan" class="mpGoogleCheckoutSpan">
                    <asp:ImageButton ImageAlign="Top" runat="server" ID="btnGoogleCheckout" OnClick="btnGoogleCheckout_Click" ImageUrl="https://checkout.google.com/buttons/checkout.gif?w=180&h=46&style=white&variant=text" CssClass="mpBtnGoogleCheckout" />
                    <asp:Image ImageAlign="Top" runat="server" ID="imgGoogleCheckoutDisabled" ImageUrl="https://checkout.google.com/buttons/checkout.gif?w=180&h=46&style=white&variant=disabled" Visible="false" CssClass="mpBtnGoogleDisabled" />
                </span>
                <span runat="server" id="PayPalExpressSpan" class="mpPayPalExpressSpan">
                    <asp:ImageButton ImageAlign="Top" ID="btnPayPalExpressCheckout" runat="server" OnClick="btnPayPalExpressCheckout_Click" CssClass="mpBtnPayPalExpressCheckout" />
                </span>
                <div class="clear" ></div>
            </li>
	                ...
	                <div id="MPOrderOptions4-content" class="clear">
                        <div class="accordion_child">
                            <table width="100%" cellpadding="4" cellspacing="0" border="0">
                                <tr>
                                    <td align="left" valign="top">
                                        <asp:Label ID="lblOrderNotes" runat="server" Text="<%$ Tokens:StringResource,shoppingcart.cs.66 %>" Font-Bold="true"></asp:Label><br />
        ...
        <ul data-role="listview">
            ...
            <li runat="server" id="AlternativeCheckouts2" class="mpAltCheckout">
                <span runat="server" id="GoogleCheckoutSpan2" class="mpGoogleCheckoutSpan">
                    <asp:ImageButton ImageAlign="Top" runat="server" ID="btnGoogleCheckout2" OnClick="btnGoogleCheckout_Click" ImageUrl="https://checkout.google.com/buttons/checkout.gif?w=180&h=46&style=white&variant=text" CssClass="mpBtnGoogleCheckout" />
                    <asp:Image ImageAlign="Top" runat="server" ID="imgGoogleCheckout2Disabled" ImageUrl="https://checkout.google.com/buttons/checkout.gif?w=180&h=46&style=white&variant=disabled" Visible="false" CssClass="mpBtnGoogleDisabled" />
                </span>
                <span runat="server" id="PayPalExpressSpan2" class="mpPayPalExpressSpan">
                    <asp:ImageButton ImageAlign="Top" ID="btnPayPalExpressCheckout2" ImageUrl="" CssClass="mpBtnPayPalExpressCheckout" runat="server" OnClick="btnPayPalExpressCheckout_Click" />
                </span>
                <div class="clear" ></div>
            </li>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('.mpGoogleCheckoutSpan div').removeClass(divClasses);
                $('.mpGoogleCheckoutSpan span').removeClass('ui-btn-inner ui-btn-corner-all');
                $('.mpPayPalExpressSpan div').removeClass(divClasses);
                $('.mpPayPalExpressSpan span').removeClass('ui-btn-inner ui-btn-corner-all');
                $('.mpBtnGoogleCheckout').removeClass('ui-btn-hidden');
