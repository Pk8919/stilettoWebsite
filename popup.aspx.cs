    ...
    public partial class popup : System.Web.UI.Page
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (CommonLogic.QueryStringCanBeDangerousContent("src").Length != 0)
            {
                ...
                if (sSrc.ToLowerInvariant().Contains("watermark"))
                {
                    if(!CommonLogic.IsStringNullOrEmpty(sSrc2))
                    {
                        sSrc += string.Format("&src2={0}", sSrc2);
                    }
                ...
                Response.Write("<img name=\"Image1\" onClick=\"javascript:self.close();\" style=\"cursor:hand;cursor:pointer;\" alt=\"" + AppLogic.GetString("popup.aspx.1", 1, Localization.GetDefaultLocale()) + "\" border=\"0\" src=\"" + ScrubImageURLS(Server.HtmlEncode(sSrc)) + "\">\n");
                Response.Write("<br/>");
            }
