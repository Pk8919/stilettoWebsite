...
<body class="rateitBG">
    <form runat="server" id="RateItForm" onsubmit="return FormValidator(this)">
            <table width="100%" cellpadding="5" cellspacing="0" border="0" class="rateittable">
                ...
                <tr>
                    <td valign="top" align="center"><asp:Button ID="btnSubmit" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnCancel" CssClass="RateItButton" OnClientClick="javascript:document.getElementById('RateItForm').onsubmit = function(){};self.close();" runat="server" /></td>
                </tr>
            </table>
